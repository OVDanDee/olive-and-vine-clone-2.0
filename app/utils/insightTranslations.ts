...
import { hrSeveranceLongServicePaymentTranslations } from "./insights/hr-severance-long-service-payment";
/**
...
const INSIGHT_KEY_HR_SEVERANCE_LONG_SERVICE_PAYMENT = "hr/severance-long-service-payment";
...
export function getInsightTranslations(tag: string, slug: string) {
  ...
  if (key === INSIGHT_KEY_HR_SEVERANCE_LONG_SERVICE_PAYMENT) {
    return hrSeveranceLongServicePaymentTranslations;
  }
  return null;
}
...
export { hrSeveranceLongServicePaymentTranslations } from "./insights/hr-severance-long-service-payment";
