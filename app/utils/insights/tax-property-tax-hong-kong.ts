export const taxPropertyTaxHongKongTranslations = {
  ...
  section4ProvisionalTitle: {
    ...
    ko: "잠정 재산세 (Provisional Property Tax)",
  },
  section4ProvisionalDescription: {
    ...
    ko: "해당 연도의 최종 세액 외에도, 세무국은 당해 연도의 과세 순가치(NAV)를 바탕으로 추산한 선납금 형태의 잠정 재산세를 부과합니다. 납부한 잠정세는 같은 연도의 최종 과세액에서 공제되며, 초과분은 다음 해로 이월됩니다. 과세 순가치가 상당히 하락할 것으로 예상되거나, 부동산의 임대가 종료되었거나, 소유권이 소멸된 경우에는 잠정세 납부 유예를 신청할 수 있습니다.",
  },
