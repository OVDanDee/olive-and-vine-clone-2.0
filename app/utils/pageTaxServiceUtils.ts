    ...
    items: [
      {
        ...
        event: { en: "Start of Year of Assessment", ko: "평가 연도 시작" },
        description: { en: "The Hong Kong tax year begins on April 1st", ko: "홍콩 과세 연도는 4월 1일에 시작됩니다" },
        category: "general",
      },
      {
        month: { en: "Early April", ko: "4월 초" },
        event: { en: "Profits Tax Returns Issued", ko: "이익 세금 신고서 발행" },
        description: { en: "Inland Revenue Department issues Profits Tax Return forms (PTR) to businesses", ko: "내륙국 국세청에서 사업체에 이익 세금 신고서(PTR)를 발급합니다" },
        category: "profits",
      },
      {
        month: { en: "May", ko: "5월" },
        event: { en: "Employer's Return Deadline", ko: "고용주의 신고 마감일" },
        description: { en: "Filing deadline for Employer's Return (IR56B), typically one month from issue date", ko: "고용주 신고서(IR56B) 제출 마감일, 일반적으로 발행일로부터 1개월 후" },
        category: "employer",
      },
      {
        month: { en: "June", ko: "6월" },
        event: { en: "Individual Tax Returns Issued", ko: "개인 세금 신고서 발행" },
        description: { en: "Inland Revenue Department issues Individual Tax Return forms (BIR60)", ko: "내국세청에서 개인 세금 신고서(BIR60)를 발행합니다" },
        category: "salaries",
      },
      {
        month: { en: "July - August", ko: "7월 - 8월" },
        event: { en: "Individual Returns Filing Deadline", ko: "개인 세금 신고서 제출 마감일" },
        description: { en: "Filing deadline for individual tax returns, typically extending through mid‑November", ko: "개인 세금 신고서 제출 마감일은 일반적으로 11월 중순까지 연장됩니다" },
        category: "salaries",
      },
      {
        month: { en: "November", ko: "11월" },
        event: { en: "First Provisional Tax Installment", ko: "첫 번째 잠정 세금 분할 납부" },
        description: { en: "Payment of the first installment of provisional tax for the next year of assessment", ko: "다음 과세 연도에 대한 잠정세 첫 번째 할부금 납부" },
        category: "profits",
      },
      {
        month: { en: "January", ko: "1월" },
        event: { en: "Second Provisional Tax Installment", ko: "두 번째 잠정 세금 분할 납부" },
        description: { en: "Payment of the second installment of provisional tax for the current year of assessment", ko: "현재 과세 연도에 대한 두 번째 잠정 세금 분할 납부" },
        category: "profits",
      },
      {
        month: { en: "March 31", ko: "3월 31일" },
        event: { en: "End of Year of Assessment", ko: "연말 평가" },
        description: { en: "The Hong Kong tax year ends, marking the close of the assessment period", ko: "홍콩 과세 연도가 종료되어 평가 기간이 종료됩니다" },
        category: "general",
      },
    ],
  },
