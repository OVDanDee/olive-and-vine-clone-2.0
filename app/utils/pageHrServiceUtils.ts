export const hrServicePageTranslations = {
  ...
  cards: {
    payroll: {
      ...
      tags: [
        ...
        { label: { en: "Payslip", ko: "급여 명세서" }, variant: "beige" as const },
      ],
    ...
    mpf: {
      ...
      tags: [
        ...
        { label: { en: "Monthly Contribution", ko: "월별 기여도" }, variant: "beige" as const },
      ],
    ...
    recruitment: {
      ...
      tags: [
        { label: { en: "Drafting JD", ko: "JD 초안 작성" }, variant: "green" as const },
    ...
    ir56: {
      ...
      tags: [
        { label: { en: "Filing", ko: "파일링" }, variant: "green" as const },
  ...
  faq: {
    ...
    items: [
      {
        question: { en: "Is it mandatory to enrol employees in the MPF scheme?", ko: "직원을 MPF 제도에 등록하는 것이 의무인가요?" },
        answer: { en: "Yes. Under the Mandatory Provident Fund Schemes Ordinance, employers in Hong Kong must enrol eligible employees in an MPF scheme within 60 days of employment. Contributions must be made by both employer and employee.", ko: "예. 의무적 퇴직연금제도 조례에 따라 홍콩의 고용주는 고용 후 60일 이내에 자격을 갖춘 직원을 MPF 제도에 등록해야 합니다. 고용주와 직원 모두 불입금을 납부해야 합니다." },
      },
      {
        question: { en: "What documents are required for a work visa application?", ko: "취업 비자 신청에 필요한 서류는 무엇인가요?" },
        answer: { en: "You will need the employee's passport, employment contract, academic and professional qualifications, and supporting documents from the employer.", ko: "직원의 여권, 고용 계약서, 학력 및 전문 자격, 고용주의 증빙 서류가 필요합니다." },
      },
      {
        question: { en: "How often must payroll be processed in Hong Kong?", ko: "홍콩에서 급여를 얼마나 자주 처리해야 하나요?" },
        answer: { en: "Payroll is typically processed monthly, but the frequency can be set according to company policy, provided it complies with employment contracts and statutory requirements.", ko: "급여는 일반적으로 매월 처리되지만, 고용 계약 및 법적 요건을 준수하는 경우 회사 정책에 따라 주기를 설정할 수 있습니다." },
      },
      {
        question: { en: "What are the employer's obligations for tax reporting?", ko: "세금 신고에 대한 고용주의 의무는 무엇인가요?" },
        answer: { en: "Employers must file Form IR56B annually for each employee and submit IR56E/IR56F/IR56G for new hires, leavers, or employees departing Hong Kong.", ko: "고용주는 매년 각 직원에 대해 IR56B 양식을 제출하고 신규 채용, 퇴사 또는 홍콩을 떠나는 직원의 경우 IR56E/IR56F/IR56G를 제출해야 합니다." },
      },
      {
        question: { en: "Can you help with drafting employment contracts and HR policies?", ko: "고용 계약서 및 인사 정책 초안 작성에 도움을 줄 수 있나요?" },
        answer: { en: "Yes, we provide advisory services to help you prepare employment contracts, staff handbooks, and workplace policies in line with Hong Kong labour laws.", ko: "예, 홍콩 노동법에 따라 고용 계약서, 직원 핸드북 및 직장 정책을 작성하는 데 도움이 되는 자문 서비스를 제공합니다." },
      },
    ],
  },
};
