...
export const ACCOUNTING_KNOWLEDGE_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Accounting", ko: "회계" },
  title: { en: "Accounting Knowledge: Financial Statements", ko: "회계 지식: 재무 제표" },
  description: { en: "", ko: "" },
...
export const CORPORATE_SECRETARY_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Corporate Service", ko: "기업 서비스" },
  title: { en: "Corporate Secretary", ko: "기업 비서" },
  description: { en: "", ko: "" },
...
export const DIVIDEND_LEGAL_CONSIDERATIONS_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Tax", ko: "세금" },
  title: { en: "Dividend and Legal Considerations", ko: "배당금 및 법적 고려 사항" },
  description: { en: "", ko: "" },
...
export const CORPORATE_TAX_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Tax", ko: "세금" },
  title: { en: "Corporate Tax and Reporting", ko: "법인세 및 보고" },
  description: { en: "", ko: "" },
...
export const DIGITAL_TRANSFORMATION_EFFICIENCY_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Consulting", ko: "컨설팅" },
  title: { en: "Digital Transformation Efficiency Improvement", ko: "디지털 혁신 효율성 향상" },
  description: { en: "", ko: "" },
...
export const DIGITAL_TRANSFORMATION_UX_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Consulting", ko: "컨설팅" },
  title: { en: "Digital Transformation UX Improvement", ko: "디지털 트랜스포메이션 UX 개선" },
  description: { en: "", ko: "" },
...
export const BIG_DATA_DRIVEN_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Consulting", ko: "컨설팅" },
  title: { en: "Big Data Driven", ko: "빅 데이터 기반" },
  description: { en: "", ko: "" },
...
export const DIGITAL_TRANSFORMATION_TVP_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Consulting", ko: "컨설팅" },
  title: { en: "Digital Transformation", ko: "디지털 트랜스포메이션" },
  description: { en: "", ko: "" },
...
export const LEGAL_CONSIDERATIONS_MA_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Consulting", ko: "컨설팅" },
  title: { en: "Legal Considerations in M&A", ko: "M&A의 법적 고려 사항" },
  description: { en: "", ko: "" },
...
export const TERMINATION_REGULATION_CARD: InsightCardDefinition = {
  ...
  tag: { en: "HR", ko: "HR" },
  title: { en: "Termination Regulation", ko: "해지 규정" },
  description: { en: "", ko: "" },
...
export const HYBRID_WORK_PERFORMANCE_CARD: InsightCardDefinition = {
  ...
  tag: { en: "HR", ko: "HR" },
  title: { en: "Hybrid Work Performance", ko: "하이브리드 업무 성과" },
  description: { en: "", ko: "" },
...
export const MANDATORY_PROVIDENT_FUND_CARD: InsightCardDefinition = {
  ...
  tag: { en: "HR", ko: "HR" },
  title: { en: "Mandatory Provident Fund", ko: "의무 지급 기금" },
  description: { en: "", ko: "" },
...
export const TAX_CLEARANCE_DEPARTING_EMPLOYEES_CARD: InsightCardDefinition = {
  ...
  tag: { en: "HR", ko: "HR" },
  title: { en: "Tax Clearance for Departing Employees", ko: "출국 직원을 위한 세금 통관" },
  description: { en: "", ko: "" },
...
export const WITHHOLDING_OBLIGATIONS_DEPARTING_EMPLOYEES_CARD: InsightCardDefinition = {
  ...
  tag: { en: "HR", ko: "HR" },
  title: { en: "Employer Withholding Obligations for Departing Employees", ko: "퇴사하는 직원에 대한 고용주의 원천징수 의무" },
  description: { en: "", ko: "" },
...
export const TWO_TIERED_SALARIES_TAX_CARD: InsightCardDefinition = {
  ...
  tag: { en: "Tax", ko: "세금" },
  title: { en: "Two-Tiered Salaries Tax in Hong Kong (2024/25)", ko: "홍콩의 2단계 급여세(2024/25년)" },
  description: { en: "", ko: "" },
...
export const EMPLOYERS_RETURN_BIR56A_CARD: InsightCardDefinition = {
  ...
  tag: { en: "HR", ko: "HR" },
  title: { en: "Annual Employer's Return (BIR56A) in Hong Kong", ko: "홍콩의 연간 고용주 신고(BIR56A)" },
  description: { en: "", ko: "" },
