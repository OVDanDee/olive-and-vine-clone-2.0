              ...
              <div className="flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-12">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  {isTaxPropertyTaxHongKong && "section1Title" in translations && (
                    <>
                      {/* Section 1 — Who Is Liable for Property Tax */}
                      <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section1Title: { en: string; ko: string } }).section1Title.ko : (translations as { section1Title: { en: string; ko: string } }).section1Title.en}</h3>
                      {"section1WhoMustPayTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section1WhoMustPayTitle: { en: string; ko: string } }).section1WhoMustPayTitle.ko : (translations as { section1WhoMustPayTitle: { en: string; ko: string } }).section1WhoMustPayTitle.en}</h4>}
                      {"section1WhoMustPayDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section1WhoMustPayDescription: { en: string; ko: string } }).section1WhoMustPayDescription.ko : (translations as { section1WhoMustPayDescription: { en: string; ko: string } }).section1WhoMustPayDescription.en}</p>}
                      {"section1NotificationTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section1NotificationTitle: { en: string; ko: string } }).section1NotificationTitle.ko : (translations as { section1NotificationTitle: { en: string; ko: string } }).section1NotificationTitle.en}</h4>}
                      {"section1NotificationDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section1NotificationDescription: { en: string; ko: string } }).section1NotificationDescription.ko : (translations as { section1NotificationDescription: { en: string; ko: string } }).section1NotificationDescription.en}</p>}
                      {"section1RentalIncomeTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section1RentalIncomeTitle: { en: string; ko: string } }).section1RentalIncomeTitle.ko : (translations as { section1RentalIncomeTitle: { en: string; ko: string } }).section1RentalIncomeTitle.en}</h4>}
                      {"section1RentalIncomeDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section1RentalIncomeDescription: { en: string; ko: string } }).section1RentalIncomeDescription.ko : (translations as { section1RentalIncomeDescription: { en: string; ko: string } }).section1RentalIncomeDescription.en}</p>}

                      {/* Section 2 — How Property Tax Is Calculated */}
                      {"section2Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section2Title: { en: string; ko: string } }).section2Title.ko : (translations as { section2Title: { en: string; ko: string } }).section2Title.en}</h3>}
                      {"section2FormulaTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2FormulaTitle: { en: string; ko: string } }).section2FormulaTitle.ko : (translations as { section2FormulaTitle: { en: string; ko: string } }).section2FormulaTitle.en}</h4>}
                      {"section2FormulaDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-2">{language === "KOR" ? (translations as { section2FormulaDescription: { en: string; ko: string } }).section2FormulaDescription.ko : (translations as { section2FormulaDescription: { en: string; ko: string } }).section2FormulaDescription.en}</p>}
                      {"section2FormulaItems" in translations && Array.isArray((translations as { section2FormulaItems?: { en: string; ko: string }[] }).section2FormulaItems) && (
                        <ol className="list-decimal list-outside pl-12 sm:pl-14 md:pl-16 mb-4 sm:mb-5 md:mb-6 space-y-1">
                          {((translations as { section2FormulaItems: { en: string; ko: string }[] }).section2FormulaItems).map((item, idx) => (
                            <li key={idx} className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed">{language === "KOR" ? item.ko : item.en}</li>
                          ))}
                        </ol>
                      )}
                      {"section2AllowanceTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2AllowanceTitle: { en: string; ko: string } }).section2AllowanceTitle.ko : (translations as { section2AllowanceTitle: { en: string; ko: string } }).section2AllowanceTitle.en}</h4>}
                      {"section2AllowanceDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2AllowanceDescription: { en: string; ko: string } }).section2AllowanceDescription.ko : (translations as { section2AllowanceDescription: { en: string; ko: string } }).section2AllowanceDescription.en}</p>}
                      {"section2NonDeductibleTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section2NonDeductibleTitle: { en: string; ko: string } }).section2NonDeductibleTitle.ko : (translations as { section2NonDeductibleTitle: { en: string; ko: string } }).section2NonDeductibleTitle.en}</h4>}
                      {"section2NonDeductibleDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section2NonDeductibleDescription: { en: string; ko: string } }).section2NonDeductibleDescription.ko : (translations as { section2NonDeductibleDescription: { en: string; ko: string } }).section2NonDeductibleDescription.en}</p>}
                      {"section2ExampleTitle" in translations && (
                        <div className="border-l-4 border-[#627F38] pl-4 py-2 mb-5 sm:mb-6 ml-4">
                          <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] mb-1">{language === "KOR" ? (translations as { section2ExampleTitle: { en: string; ko: string } }).section2ExampleTitle.ko : (translations as { section2ExampleTitle: { en: string; ko: string } }).section2ExampleTitle.en}</h4>
                          {"section2ExampleDescription" in translations && <p className="text-sm sm:text-base md:text-lg text-[#111B12] leading-relaxed">{language === "KOR" ? (translations as { section2ExampleDescription: { en: string; ko: string } }).section2ExampleDescription.ko : (translations as { section2ExampleDescription: { en: string; ko: string } }).section2ExampleDescription.en}</p>}
                        </div>
                      )}

                      {/* Section 3 — Filing Your Property Tax Return */}
                      {"section3Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section3Title: { en: string; ko: string } }).section3Title.ko : (translations as { section3Title: { en: string; ko: string } }).section3Title.en}</h3>}
                      {"section3FormsTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section3FormsTitle: { en: string; ko: string } }).section3FormsTitle.ko : (translations as { section3FormsTitle: { en: string; ko: string } }).section3FormsTitle.en}</h4>}
                      {"section3FormsDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section3FormsDescription: { en: string; ko: string } }).section3FormsDescription.ko : (translations as { section3FormsDescription: { en: string; ko: string } }).section3FormsDescription.en}</p>}
                      {"section3DeadlineTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section3DeadlineTitle: { en: string; ko: string } }).section3DeadlineTitle.ko : (translations as { section3DeadlineTitle: { en: string; ko: string } }).section3DeadlineTitle.en}</h4>}
                      {"section3DeadlineDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section3DeadlineDescription: { en: string; ko: string } }).section3DeadlineDescription.ko : (translations as { section3DeadlineDescription: { en: string; ko: string } }).section3DeadlineDescription.en}</p>}
                      {"section3ProvisionalTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section3ProvisionalTitle: { en: string; ko: string } }).section3ProvisionalTitle.ko : (translations as { section3ProvisionalTitle: { en: string; ko: string } }).section3ProvisionalTitle.en}</h4>}
                      {"section3ProvisionalDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section3ProvisionalDescription: { en: string; ko: string } }).section3ProvisionalDescription.ko : (translations as { section3ProvisionalDescription: { en: string; ko: string } }).section3ProvisionalDescription.en}</p>}

                      {/* Section 4 — Corporations: Exemption from Property Tax */}
                      {"section4Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section4Title: { en: string; ko: string } }).section4Title.ko : (translations as { section4Title: { en: string; ko: string } }).section4Title.en}</h3>}
                      {"section4ProblemTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4ProblemTitle: { en: string; ko: string } }).section4ProblemTitle.ko : (translations as { section4ProblemTitle: { en: string; ko: string } }).section4ProblemTitle.en}</h4>}
                      {"section4ProblemDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4ProblemDescription: { en: string; ko: string } }).section4ProblemDescription.ko : (translations as { section4ProblemDescription: { en: string; ko: string } }).section4ProblemDescription.en}</p>}
                      {"section4ExemptionTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section4ExemptionTitle: { en: string; ko: string } }).section4ExemptionTitle.ko : (translations as { section4ExemptionTitle: { en: string; ko: string } }).section4ExemptionTitle.en}</h4>}
                      {"section4ExemptionDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section4ExemptionDescription: { en: string; ko: string } }).section4ExemptionDescription.ko : (translations as { section4ExemptionDescription: { en: string; ko: string } }).section4ExemptionDescription.en}</p>}

                      {/* Section 5 — Individuals: The Personal Assessment Election */}
                      {"section5Title" in translations && <h3 className="text-lg sm:text-xl md:text-2xl lg:text-[26px] font-semibold text-[#627F38] mb-3 sm:mb-3.5 md:mb-4">{language === "KOR" ? (translations as { section5Title: { en: string; ko: string } }).section5Title.ko : (translations as { section5Title: { en: string; ko: string } }).section5Title.en}</h3>}
                      {"section5WhatTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5WhatTitle: { en: string; ko: string } }).section5WhatTitle.ko : (translations as { section5WhatTitle: { en: string; ko: string } }).section5WhatTitle.en}</h4>}
                      {"section5WhatDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section5WhatDescription: { en: string; ko: string } }).section5WhatDescription.ko : (translations as { section5WhatDescription: { en: string; ko: string } }).section5WhatDescription.en}</p>}
                      {"section5WhenHelpTitle" in translations && <h4 className="text-sm sm:text-base md:text-lg lg:text-[18px] xl:text-[16px] font-semibold text-[#333333] pl-4 sm:pl-5 md:pl-6 mb-2">{language === "KOR" ? (translations as { section5WhenHelpTitle: { en: string; ko: string } }).section5WhenHelpTitle.ko : (translations as { section5WhenHelpTitle: { en: string; ko: string } }).section5WhenHelpTitle.en}</h4>}
                      {"section5WhenHelpDescription" in translations && <p className="text-sm sm:text-base md:text-lg lg:text-[18px] text-[#111B12] leading-relaxed text-justify pl-8 sm:pl-10 md:pl-12 mb-4 sm:mb-5 md:mb-6">{language === "KOR" ? (translations as { section5WhenHelpDescription: { en: string; ko: string } }).section5WhenHelpDescription.ko : (translations as { section5WhenHelpDescription: { en: string; ko: string } }).section5WhenHelpDescription.en}</p>}
                    </>
                  )}
